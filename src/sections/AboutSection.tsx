...
export const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="relative min-h-screen w-full bg-[#0C0C0C] px-5 sm:px-8 md:px-10 pt-36 sm:pt-48 md:pt-60 pb-28 sm:pb-36 md:pb-44 flex flex-col items-center justify-center overflow-hidden"
    >
      {/* 1. Decorative Corner 3D Elements */}
      {/* Top-Left: Moon Icon */}
      <div className="absolute top-[12%] sm:top-[14%] md:top-[16%] left-[1%] sm:left-[2%] md:left-[4%] pointer-events-none z-10">
      ...
      {/* Top-Right: Lego Icon */}
      <div className="absolute top-[12%] sm:top-[14%] md:top-[16%] right-[1%] sm:right-[2%] md:right-[4%] pointer-events-none z-10">
