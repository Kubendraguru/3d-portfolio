...
export const MarqueeSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#0C0C0C] pt-20 sm:pt-28 md:pt-36 pb-16 overflow-hidden select-none z-10"
    >
      {/* Section Title matching "Project" and "Skills" */}
      <div className="max-w-6xl mx-auto flex flex-col items-center px-4 mb-14 sm:mb-18 md:mb-24">
      ...
      {/* Dual Row Kinetic Scroll Marquee */}
