...
export interface TypingKeyboardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Optional callback fired when initial auto-type completes */
  onComplete?: () => void;
}
...
export function TypingKeyboard({
  className,
  autoTypeText = "Kubendra Guru. 3D Web Experiences, Full-Stack Architecture, and Creative Engineering. Welcome to my portfolio...     ",
  typingSpeed = [35, 90],
  scale = 0.8,
  accentColor = "#38BDF8",
  ...
  }, [autoTypeText, typingSpeed, onComplete]);
